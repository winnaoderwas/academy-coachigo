        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-12 animate-fade-in">
            <div className="inline-block px-3 py-1 rounded-full bg-blue-100 text-blue-700 font-semibold text-sm mb-4">
              {language === 'en' ? 'Browse Our Courses' : 'Unsere Kurse durchsuchen'}
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              {language === 'en' ? 'Courses for Every Level' : 'Kurse für jedes Niveau'}
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              {language === 'en'
                ...
                : 'Entdecken Sie unser umfassendes Angebot an Kursen, die darauf ausgelegt sind, Sie vom Anfänger zum Experten zu führen. Filtern Sie nach Niveau, Format und Kategorie, um den perfekten Kurs für Ihren Lernweg zu finden.'}
            </p>
          </div>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12 glass rounded-xl animate-fade-in">
                  <h3 className="text-xl font-semibold mb-2">
                    {language === 'en' ? 'Error loading courses' : 'Fehler beim Laden der Kurse'}
                  </h3>
                  <p className="text-gray-600 mb-4">
                    {language === 'en'
                      ? 'We encountered an error while loading the courses. Please try again later.'
                      : 'Beim Laden der Kurse ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut.'}
                  </p>
                  <button
                ...
                <div className="text-center py-12 glass rounded-xl animate-fade-in">
                  ...
                  <p className="text-gray-600 mb-4">
                    {language === 'en'
                      ...
                      : 'Wir konnten keine Kurse finden, die Ihren Filtern entsprechen.'}
                  </p>
                  <button
